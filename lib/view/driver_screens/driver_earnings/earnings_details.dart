                    ...
                    child: BarChart(BarChartData(
                        ...
                        barGroups: [
                          BarChartGroupData(x: 1, barRods: [
                            BarChartRodData(
                                fromY: 0, toY: 10, color: Themecolor.container)
                          ]),
                          BarChartGroupData(x: 2, barRods: [
                            BarChartRodData(
                                fromY: 0, toY: 7, color: Themecolor.container)
                          ]),
                          BarChartGroupData(x: 3, barRods: [
                            BarChartRodData(
                                fromY: 0, toY: 5, color: Themecolor.container)
                          ]),
                          BarChartGroupData(x: 1, barRods: [
                            BarChartRodData(
                          ...
                          BarChartGroupData(x: 5, barRods: [
                            BarChartRodData(
                                fromY: 0, toY: 6, color: Themecolor.container)
                          ]),
